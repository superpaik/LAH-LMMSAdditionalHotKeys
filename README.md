...
<ul>
	...
	<li>You can download it to any local folder. Upon executing the exe an icon try will be added and the hotkeys available. From there you can also exit the script, suspend or pause it in case it alters the behaviour of other program's hotkeys.</li>
</ul>
